...
class Blockchain {
   ...
   /**
     * Utility method that returns current UTC timestamp
     */
    _getUTCTimestamp(){
    ...
    submitStar(address, message, signature, star) {
        ...
        return new Promise(async (resolve, reject) => {
            ...
            if (currentTime - time > allowedDelay ) reject(new Error('Time elapsed greater than 5 minutes'));
    ...
    getBlockByHash(hash) {
        ...
        return new Promise((resolve, reject) => {
            ...
            if (!foundBlock) reject (new Error('Block not found with' + hash));
            resolve(foundBlock);
    ...
    validateChain() {
        ...
        return new Promise(async (resolve, reject) => { 
             ...
             {
                const currentBlock = this.chain[b];
                ...
                if(b > 0)
                {
                    const previousBlock = this.chain[b -1];
